export const siteConfig = {
  name: 'إشراقة وعي',
  nameEn: 'Ishraqah Waie',
  tagline: 'تعزيز الوعي النفسي والتربوي من خلال الاستشارات والمؤلفات',
  description:
    'إشراقة وعي - منصة متخصصة في تعزيز الوعي النفسي والتربوي، تقدم استشارات نفسية ومقالات تربوية ومحتوى توعوي بإشراف الأستاذة رانية طه الودية',
